...
namespace NVNC.Encodings
{
    ...
    {
        private int[] pixels;
        public RawRectangle(RfbProtocol rfb, Framebuffer framebuffer, int[] pixels, Rectangle rectangle)
            : base(rfb, framebuffer, rectangle, RfbProtocol.Encoding.RAW_ENCODING)
        {
            this.pixels = pixels;
        }
