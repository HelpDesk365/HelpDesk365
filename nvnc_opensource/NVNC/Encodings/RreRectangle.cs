...
namespace NVNC.Encodings
{
    ...
    public class RreRectangle : EncodedRectangle
    {
        ...
        public RreRectangle(RfbProtocol rfb, Framebuffer framebuffer, int[] pixels, Rectangle rectangle)
            : base(rfb, framebuffer, rectangle, RfbProtocol.Encoding.RRE_ENCODING)
        {
            this.pixels = pixels;
        }
